...
import { transformPhase7CSidewayM5StructuralTrailingSource } from "./phase7c-m5-structural-trailing-source-adapter.mjs";
...
const accountAdapted = mode === "LIVE"
  ...
  : source;
const canonicalAdapted = transformPhase7CSidewayCanonicalDailyRecoverySource(accountAdapted);
const output = transformPhase7CSidewayM5StructuralTrailingSource(canonicalAdapted);
