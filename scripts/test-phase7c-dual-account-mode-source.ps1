...
Assert-Text "apps/api/src/services/phase7c-lifecycle.service.ts" 'phase7CBotModeService\.set\("AUTO",\s*"web-control-center-start"\)' "web start may enter AUTO only after verified runtime startup"
